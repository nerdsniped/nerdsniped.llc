...
export default function Home({
  ...
  return (
    <>
      <Head>
        <title>Nerdsniped LLC</title>
        <meta
          name="description"
          content="A software consultancy based in Oakland, doing stuff with computers."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Software consultancy doing things with computers in Oakland, CA.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            We&apos;re Nerdsniped LLC, a software consultancy based in Oakland,
            CA. We specialize in doing stuff with computers, in exchange for
            money.
          </p>
